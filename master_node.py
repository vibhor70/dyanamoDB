...
if __name__ == "__main__":
    ...
    a.send_command(["172.17.0.2"], {"USERID":"1", "PRODUCTID":"2","OPERATION":"3","PRICE":"4","CATEGORY":"120"})
    a.send_command(["172.17.0.2"], {"USERID":"1", "PRODUCTID":"3","OPERATION":"5","PRICE":"45","CATEGORY":"120"})
    a.send_command(["172.17.0.2"], {"USERID":"1", "PRODUCTID":"4","OPERATION":"3","PRICE":"4","CATEGORY":"120"})
    a.send_command(["172.17.0.2"], {"USERID":"1", "PRODUCTID":"2","OPERATION":"3","PRICE":"4","CATEGORY":"120"})
    a.send_command(["172.17.0.2"], {"USERID":"1", "PRODUCTID":"2","OPERATION":"3","PRICE":"4","CATEGORY":"120"})

    # a.send_command(["172.17.0.3"], {"USERID":"1", "PRODUCTID":"4","OPERATION":"3","PRICE":"4","CATEGORY":"120"})
    # a.send_command(["172.17.0.3"], {"USERID":"1", "PRODUCTID":"4","OPERATION":"3","PRICE":"4","CATEGORY":"120"})
    # a.send_command(["172.17.0.3"], {"USERID":"1", "PRODUCTID":"4","OPERATION":"3","PRICE":"4","CATEGORY":"120"})
